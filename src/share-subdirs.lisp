...
(defun share-subdirs-list ()
  '#.(remove-if-not
      ...
      '(
"affine" "algebra" "algebra/charsets" "algebra/solver" "calculus" "cobyla" "cobyla/ex" "cobyla/lisp" "colnew" "colnew/ex1" "colnew/ex2" "colnew/ex3" "colnew/lisp" "combinatorics" "contrib" "contrib/Grobner" "contrib/Zeilberger" "contrib/altsimp" "contrib/amatrix" "contrib/bitwise" "contrib/boolsimp" "contrib/descriptive" "contrib/descriptive/doc" "contrib/diffequations" "contrib/diffequations/tests" "contrib/distrib" "contrib/distrib/doc" "contrib/dynamics" "contrib/ezunits" "contrib/finance" "contrib/format" "contrib/fourier_elim" "contrib/fractals" "contrib/fresnel" "contrib/gentran" "contrib/gentran/man" "contrib/gentran/test" "contrib/gf" "contrib/graphs" "contrib/integration" "contrib/levin" "contrib/lurkmathml" "contrib/maximaMathML" "contrib/mcclim" "contrib/namespaces" "contrib/noninteractive" "contrib/nset" "contrib/numericalio" "contrib/pdiff" "contrib/prim" "contrib/rand" "contrib/sarag" "contrib/simplex" "contrib/simplex/Tests" "contrib/solve_rec" "contrib/state" "contrib/stats" "contrib/stringproc" "contrib/unit" "contrib/vector3d" "diff_form" "diffequations" "draw" "dynamics" "graphics" "hypergeometric" "integequations" "integration" "lapack" "lapack/blas" "lapack/lapack" "lbfgs" "linearalgebra" "macro" "matrix" "minpack" "minpack/lisp" "misc" "numeric" "orthopoly" "physics" "simplification" "specfunctions" "sym" "tensor" "tensor/tests" "trigonometry" "utils" "vector" 
	)))
