...
(defmfun $factcomb (e)
  (let ((varlist varlist) (genvar nil) $ratfac (ratrep (and (not (atom e)) (eq (caar e) 'mrat))))
...
(defun sumsum (e poly-var lo hi *plus *times)
  ;; Results belong to this invocation, including during nested simplification.
  ;; SMONO also returns its coefficient and power through special variables.
  (let (combin-sum combin-usum *a *n)
    (labels
        ((adsum (e)
         ...
         (fpolysum (e lo hi poly-var)    ;returns *combin-ans*
