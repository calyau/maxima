    ...
    (cond ((or (and (floatp u) (floatp m))
	  ...
	  ((and $numer (complex-number-p u)
	   ...
	   (let ((u-r ($realpart u))
		 ...
		 (m-r ($realpart m))
		 (m-i ($imagpart m)))
	     (complexify (/ (bigfloat::sn (complex u-r u-i) (complex m-r m-i))))))
	  ((zerop1 m)
	   ;; A&S 16.6.10
	   `(($csc) ,u))
	  ((onep1 m)
    ...
    (cond ((or (and (floatp u) (floatp m))
	  ...
	  ((and $numer (complex-number-p u)
	   ...
	   (let ((u-r ($realpart u))
		 ...
		 (m-r ($realpart m))
		 (m-i ($imagpart m)))
	     (complexify (/ (bigfloat::cn (complex u-r u-i) (complex m-r m-i))))))
	  ((zerop1 u)
	   1)
	  ((zerop1 m)
	   ;; A&S 16.6.8
    ...
    (cond ((or (and (floatp u) (floatp m))
	  ...
	  ((and $numer (complex-number-p u)
	   ...
	   (let ((u-r ($realpart u))
		 ...
		 (m-r ($realpart m))
		 (m-i ($imagpart m)))
	     (complexify (/ (bigfloat::dn (complex u-r u-i) (complex m-r m-i))))))
	  ((zerop1 u)
	   1)
	  ((zerop1 m)
	   ;; A&S 16.6.6
...
(defmfun simp-%jacobi_sc (form unused z)
  ...
  (let ((u (simpcheck (cadr form) z))
    ...
    (cond ((or (and (floatp u) (floatp m))
	   ...
	   (let ((fu (float u))
		 (fm (float m)))
	     (/ (bigfloat::sn fu fm) (bigfloat::cn fu fm))))
	  ((and $numer (complex-number-p u)
		(complex-number-p m))
	   (let ((u-r ($realpart u))
		 (u-i ($imagpart u))
		 ...
		 (m-i ($imagpart m)))
	     (complexify (/ (bigfloat::sn (complex u-r u-i) (complex m-r m-i))
			    (bigfloat::cn (complex u-r u-i) (complex m-r m-i))))))
	  ((zerop1 u)
	   0)
	  ((zerop1 m)
	   ;; A&S 16.6.9
...
(defmfun simp-%jacobi_sd (form unused z)
  ...
  (let ((u (simpcheck (cadr form) z))
    ...
    (cond ((or (and (floatp u) (floatp m))
	   ...
	   (let ((fu (float u))
		 (fm (float m)))
	     (/ (bigfloat::sn fu fm) (bigfloat::dn fu fm))))
	  ((and $numer (complex-number-p u)
		(complex-number-p m))
	   (let ((u-r ($realpart u))
		 (u-i ($imagpart u))
		 ...
		 (m-i ($imagpart m)))
	     (complexify (/ (bigfloat::sn (complex u-r u-i) (complex m-r m-i))
			    (bigfloat::dn (complex u-r u-i) (complex m-r m-i))))))
	  ((zerop1 u)
	   0)
	  ((zerop1 m)
	   ;; A&S 16.6.5
...
(defmfun simp-%jacobi_cs (form unused z)
  ...
  (let ((u (simpcheck (cadr form) z))
    ...
    (cond ((or (and (floatp u) (floatp m))
	   ...
	   (let ((fu (float u))
		 (fm (float m)))
	     (/ (bigfloat::cn fu fm) (bigfloat::sn fu fm))))
	  ((and $numer (complex-number-p u)
		(complex-number-p m))
	   (let ((u-r ($realpart u))
		 (u-i ($imagpart u))
		 ...
		 (m-i ($imagpart m)))
	     (complexify (/ (bigfloat::cn (complex u-r u-i) (complex m-r m-i))
			    (bigfloat::sn (complex u-r u-i) (complex m-r m-i))))))
	  ((zerop1 m)
	   ;; A&S 16.6.12
	   `(($cot) ,u))
	  ((onep1 m)
...
(defmfun simp-%jacobi_cd (form unused z)
  ...
  (let ((u (simpcheck (cadr form) z))
    ...
    (cond ((or (and (floatp u) (floatp m))
	   ...
	   (let ((fu (float u))
		 (fm (float m)))
	     (/ (bigfloat::cn fu fm) (bigfloat::dn fu fm))))
	  ((and $numer (complex-number-p u)
		(complex-number-p m))
	   (let ((u-r ($realpart u))
		 (u-i ($imagpart u))
...
(defmfun simp-%jacobi_ds (form unused z)
  ...
  (let ((u (simpcheck (cadr form) z))
    ...
    (cond ((or (and (floatp u) (floatp m))
	   ...
	   (let ((fu (float u))
		 (fm (float m)))
	     (/ (bigfloat::dn fu fm) (bigfloat::sn fu fm))))
	  ((and $numer (complex-number-p u)
		(complex-number-p m))
	   (let ((u-r ($realpart u))
		 (u-i ($imagpart u))
...
(defmfun simp-%jacobi_dc (form unused z)
  ...
  (let ((u (simpcheck (cadr form) z))
    ...
    (cond ((or (and (floatp u) (floatp m))
	   ...
	   (let ((fu (float u))
		 (fm (float m)))
	     (/ (bigfloat::dn fu fm) (bigfloat::cn fu fm))))
	  ((zerop1 u)
	   1)
	  ((zerop1 m)
	   ;; A&S 16.6.7
