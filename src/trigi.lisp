...
(DEFMFUN SIMP-%SIN (FORM Y Z) 
  ...
  (COND ((OR (FLOATP Y) (AND $NUMER (INTEGERP Y))) (SIN Y))
...
(DEFMFUN SIMP-%COS (FORM Y Z) 
  (ONEARGCHECK FORM)
  (SETQ Y (SIMPCHECK (CADR FORM) Z))
  (COND ((OR (FLOATP Y) (AND $NUMER (INTEGERP Y))) (COS Y))
	(($BFLOATP Y) ($BFLOAT FORM))
...
(DEFMFUN SIMP-%TAN (FORM Y Z)
  (ONEARGCHECK FORM)
  (SETQ Y (SIMPCHECK (CADR FORM) Z))
  (COND ((OR (FLOATP Y) (AND $NUMER (INTEGERP Y))) (TAN Y))
	(($BFLOATP Y) ($BFLOAT FORM))
...
(DEFMFUN SIMP-%COT (FORM Y Z)
  (ONEARGCHECK FORM)
  (SETQ Y (SIMPCHECK (CADR FORM) Z))
  (COND ((OR (FLOATP Y) (AND $NUMER (INTEGERP Y))) (COT Y))
	(($BFLOATP Y) ($BFLOAT FORM))
...
(DEFMFUN SIMP-%CSC (FORM Y Z)
  (ONEARGCHECK FORM)
  (SETQ Y (SIMPCHECK (CADR FORM) Z))
  (COND ((OR (FLOATP Y) (AND $NUMER (INTEGERP Y))) (CSC Y))
	(($BFLOATP Y) ($BFLOAT FORM))
...
(DEFMFUN SIMP-%SEC (FORM Y Z)
  (ONEARGCHECK FORM)
  (SETQ Y (SIMPCHECK (CADR FORM) Z))
  (COND ((OR (FLOATP Y) (AND $NUMER (INTEGERP Y))) (SEC Y))
	(($BFLOATP Y) ($BFLOAT FORM))
...
(DEFMFUN SIMP-%ATAN (FORM Y Z)
  (ONEARGCHECK FORM)
  (SETQ Y (SIMPCHECK (CADR FORM) Z))
  (COND ((OR (FLOATP Y) (AND $NUMER (INTEGERP Y))) (ATAN1 Y))
	(($BFLOATP Y) ($BFLOAT FORM))
	((AND $%PIARGS
