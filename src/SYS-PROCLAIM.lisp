...
(PROCLAIM
    '(FTYPE (FUNCTION * T) NLEFT STRING-SEARCH $FORTMX
...
(PROCLAIM
    '(FTYPE (FUNCTION * T) $TLIMIT $LIMIT $DELETE $GCD LIMIT-LIST
            ...
            $RATCOEF)) 
(PROCLAIM '(FTYPE (FUNCTION * T) D-VBAR)) 
(PROCLAIM '(FTYPE (FUNCTION (T FIXNUM FIXNUM FIXNUM T) T) D-BOX)) 
(PROCLAIM '(FTYPE (FUNCTION * T) D-HBAR)) 
...
(PROCLAIM
    '(FTYPE (FUNCTION (T) T) PACOEFP DISREP ATAN2NEGP ILT3 LAPDEFINT
            ...
            *TMREARRAY FINDBE PDECGDFRM #+gcl COMPILER::FN-P SP2INTEG1
            OPMEXPT CHECK-INF-SING FACMGCD TAN APPLY2HACK SINH
            $COLLAPSE COSH NFORMAT-ALL TANH DISPRULE1 OLDREP
            #+gcl COMPILER::FN-NAME CONSRULE #+gcl COMPILER::FN-DEF
            PROCLAIM-PROPERTY #+gcl COMPILER::FN-VALUE-TYPE SUBST1
            #+gcl COMPILER::FN-FUN-VALUES PSFLOAT #+gcl COMPILER::FN-CALLEES
            AT-SUBSTP #+gcl COMPILER::FN-RETURN-TYPE MULTIDEG
            #+gcl COMPILER::FN-ARG-TYPES NEWREP #+gcl COMPILER::FN-NO-EMIT OPTIONS
            #+gcl COMPILER::FN-MACROS DOWN SPECREPCHECK ADJOIN-DATUM
            ...
            CONSTA $NTERMS)) 
(PROCLAIM
    '(FTYPE (FUNCTION * *) MFUNCALL APPLICATION-OPERATOR $EXAMPLE
            MACLISP-TYPEP)) 
...
(PROCLAIM
    '(FTYPE (FUNCTION * T) BREAK-FUNCTION BREAK-STEP-INTO
...
(PROCLAIM
    '(FTYPE (FUNCTION (T T) *) RETRIEVE1 PRINT-ONE-FRAME TESTDIVIDE
            ...
            PNTHROOTP LOAD-FUNCTION SP1EXPT TRACE-APPLY
            APPEARS-IN EZTESTDIVIDE)) 
(PROCLAIM '(FTYPE (FUNCTION (T T T) *) ARRFUNCALL))
