...
(PROCLAIM '(FTYPE (FUNCTION (T T) T) BIGFLOAT::BF-ELLIPTIC-F)) 
(PROCLAIM '(FTYPE (FUNCTION (T) *) BIGFLOAT::BF-ELLIPTIC-K)) 
(PROCLAIM '(FTYPE (FUNCTION (T T) *) BIGFLOAT::BF-RC)) 
(PROCLAIM '(FTYPE (FUNCTION (T T T) T) BIGFLOAT::BF-RD)) 
(PROCLAIM '(FTYPE (FUNCTION (T T T) *) BIGFLOAT::BF-RF)) 
(PROCLAIM '(FTYPE (FUNCTION (T T T) T) BIGFLOAT::BF-RG)) 
(PROCLAIM '(FTYPE (FUNCTION (T T T T) *) BIGFLOAT::BF-RJ)) 
(PROCLAIM '(FTYPE (FUNCTION (T T T T) T) BIGFLOAT::BF-RJ1)) 
...
(PROCLAIM '(FTYPE (FUNCTION (T T) *) INTL::DOMAIN-LOOKUP)) 
...
(PROCLAIM '(FTYPE (FUNCTION (T T) T) MAXIMA::FILLARRAY)) 
(PROCLAIM '(FTYPE (FUNCTION (T T T) *) MAXIMA::FILTER-SUM)) 
...
(PROCLAIM
    '(FTYPE (FUNCTION (T T) *) MAXIMA::GET-NOT-CONST-OR-INT-TERMS)) 
...
(PROCLAIM '(FTYPE (FUNCTION (T T T) T) MAXIMA::SIMP-$ELLIPTIC_PI)) 
...
(PROCLAIM '(FTYPE (FUNCTION (T T T) T) MAXIMA::SIMP-%ELLIPTIC_EC)) 
