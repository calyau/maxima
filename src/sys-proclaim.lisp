...
(PROCLAIM '(FTYPE (FUNCTION (T) T) COMMAND-LINE::EXPAND-ARGS)) 
(PROCLAIM '(FTYPE (FUNCTION (T) T) COMMAND-LINE::EXPAND-COMPOUND-ARG)) 
(PROCLAIM '(FTYPE (FUNCTION (T) T) COMMAND-LINE::EXPAND-EQUALS-ARG)) 
(PROCLAIM '(FTYPE (FUNCTION (T T) T) COMMAND-LINE::IN-LIST)) 
(PROCLAIM '(FTYPE (FUNCTION (T T) T) COMMAND-LINE::PARSE-ARGS)) 
...
(PROCLAIM '(FTYPE (FUNCTION (STRING T) *) INTL::DOMAIN-LOOKUP)) 
(PROCLAIM '(FTYPE (FUNCTION (T T *) *) INTL::FIND-DOMAIN)) 
(PROCLAIM '(FTYPE (FUNCTION (T) T) INTL::GETENV)) 
(PROCLAIM '(FTYPE (FUNCTION (T) T) INTL::GUESS-LOCALE-ENCODING)) 
...
(PROCLAIM '(FTYPE (FUNCTION (T) T) MAXIMA::$APROPOS)) 
...
(PROCLAIM '(FTYPE (FUNCTION (T) T) MAXIMA::DECLARED-COMPLEX-P)) 
...
(PROCLAIM '(FTYPE (FUNCTION (T) *) MAXIMA::EITGAMMAINCOMPLETE)) 
...
(PROCLAIM '(FTYPE (FUNCTION (T T) T) MAXIMA::IN-LIST)) 
...
(PROCLAIM '(FTYPE (FUNCTION (T T T) T) MAXIMA::MARK+3)) 
(PROCLAIM '(FTYPE (FUNCTION (T T) T) MAXIMA::MARK-)) 
(PROCLAIM '(FTYPE (FUNCTION (T T T) T) MAXIMA::MARK-0)) 
(PROCLAIM '(FTYPE (FUNCTION (T T T) T) MAXIMA::MARK-1)) 
...
(PROCLAIM '(FTYPE (FUNCTION (T) *) MAXIMA::RISPLIT-EXPT)) 
