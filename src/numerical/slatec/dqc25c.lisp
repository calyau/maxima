  ...
  (defun dqc25c (f a b c result abserr krul neval)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((fval (make-array 25 :element-type 'double-float))
             ...
             (isym 0) (k 0) (kp 0) (ak22 0.0) (amom0 0.0) (amom1 0.0)
             (amom2 0.0) (cc 0.0) (centr 0.0) (hlgth 0.0) (p2 0.0) (p3 0.0)
       ...
       label10
        ...
        (setf amom0
                (coerce (f2cl-lib:flog (abs (/ (- 1.0 cc) (+ 1.0 cc))))
                        'double-float))
        ...
        (f2cl-lib:fdo (k 14 (f2cl-lib:int-add k 1))
          ...
          (tagbody
           ...
           label40))
        (setf result res24)
        (setf abserr (coerce (abs (- res24 res12)) 'double-float))
       label50
        (go end_label)
       end_label
