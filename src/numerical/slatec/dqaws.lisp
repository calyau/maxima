...
(defun dqaws
  ...
  (prog ((lvl 0) (l1 0) (l2 0) (l3 0))
    ...
    (multiple-value-bind
        ...
        (dqawse f a b alfa beta integr epsabs epsrel limit result abserr neval
         ier (f2cl-lib:array-slice work double-float (1) ((1 *)))
   ...
   label10
    ...
    (if (/= ier 0)
        (multiple-value-bind
            ...
            (xermsg "SLATEC" "DQAWS" "ABNORMAL RETURN" ier lvl)
