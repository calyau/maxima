;;; Compiled by f2cl version 2.0 beta on 2002/04/25 at 13:19:16
;;; 
  ...
  (defun zbesj (zr zi fnu kode n cyr cyi nz ierr)
    ...
    (f2cl-lib:with-array-data (cyi-%data% cyi-%offset% cyi)
      ...
      (f2cl-lib:with-array-data (cyr-%data% cyr-%offset% cyr)
        ...
        (prog ((i 0) (inu 0) (inuh 0) (ir 0) (k 0) (k1 0) (k2 0) (nl 0)
               (aa 0.0) (alim 0.0) (arg 0.0) (cii 0.0) (csgni 0.0) (csgnr 0.0)
               (dig 0.0) (elim 0.0) (fnul 0.0) (rl 0.0) (r1m5 0.0) (str 0.0)
               (tol 0.0) (zni 0.0) (znr 0.0) (bb 0.0) (fn 0.0) (az 0.0)
               (ascle 0.0) (rtol 0.0) (atol 0.0) (sti 0.0))
          (declare
         ...
         label260
          ...
          (go end_label)
         end_label
          (return (values zr zi fnu kode n nil nil nz ierr)))))))
