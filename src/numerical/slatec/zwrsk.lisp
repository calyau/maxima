...
(defun zwrsk (zrr zri fnu kode n yr yi nz cwr cwi tol elim alim)
  ...
  (prog ((i 0) (nw 0) (act 0.0) (acw 0.0) (ascle 0.0) (cinui 0.0) (cinur 0.0)
   ...
   label30
    ...
    (f2cl-lib:fset (f2cl-lib:fref yr (1) ((1 n))) (* cinur csclr))
    (f2cl-lib:fset (f2cl-lib:fref yi (1) ((1 n))) (* cinui csclr))
    (if (= n 1) (go end_label))
    (f2cl-lib:fdo (i 2 (f2cl-lib:int-add i 1))
      ...
      (tagbody
        ...
        (f2cl-lib:fset (f2cl-lib:fref yr (i) ((1 n))) (* cinur csclr))
        (f2cl-lib:fset (f2cl-lib:fref yi (i) ((1 n))) (* cinui csclr))
       label40))
    (go end_label)
   label50
    (setf nz -1)
