  ...
  (defun dqc25f
    ...
    (prog ((cheb12 (make-array 13 :element-type 'double-float))
      ...
      (declare (type single-float abs$)
       (type (simple-array double-float (28)) v)
       (type (simple-array double-float (25)) fval d2 d1 d cheb24)
     ...
     label10
      ...
      (f2cl-lib:fset (f2cl-lib:fref v (1) ((1 28))) (/ (* 2.0 sinpar) parint))
     ...
     label100
      (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
        ...
        (tagbody
          (f2cl-lib:fset
           (f2cl-lib:fref chebmo (m (f2cl-lib:int-mul 2 j)) ((1 maxp1) (1 25)))
           (f2cl-lib:fref v (j) ((1 28))))
         label110))
     label120
      ...
      (setf resc12
              (* (f2cl-lib:fref cheb12 (13) ((1 13)))
                 (f2cl-lib:fref chebmo (m 13) ((1 maxp1) (1 25)))))
      (setf ress12 0.0)
      (setf k 11)
      (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                    ((> j 6) nil)
          ...
          (setf resc12
                  (+ resc12
                     (* (f2cl-lib:fref cheb12 (k) ((1 13)))
                        (f2cl-lib:fref chebmo (m k) ((1 maxp1) (1 25))))))
          (setf ress12
                  (+ ress12
                     (*
                      (f2cl-lib:fref cheb12 ((f2cl-lib:int-add k 1)) ((1 13)))
                      (f2cl-lib:fref chebmo
      ...
      (setf resc24
              (* (f2cl-lib:fref cheb24 (25) ((1 25)))
                 (f2cl-lib:fref chebmo (m 25) ((1 maxp1) (1 25)))))
      (setf ress24 0.0)
      (setf resabs
      ...
      (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
        ...
        (tagbody
          ...
          (setf ress24
                  (+ ress24
                     (*
                      (f2cl-lib:fref cheb24 ((f2cl-lib:int-add k 1)) ((1 25)))
                      (f2cl-lib:fref chebmo
                                     (m (f2cl-lib:int-add k 1))
                                     ((1 maxp1) (1 25))))))
          (setf resabs
