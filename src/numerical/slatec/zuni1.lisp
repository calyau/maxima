;;; Compiled by f2cl version 2.0 beta on 2002/04/25 at 13:19:40
;;; 
    ...
    (f2cl-lib:with-array-data (yi-%data% yi-%offset% yi)
      ...
      (f2cl-lib:with-array-data (yr-%data% yr-%offset% yr)
        ...
        (prog ((bry (make-array 3 :element-type 'double-float))
               ...
               (s1i 0.0) (s1r 0.0) (s2i 0.0) (s2r 0.0) (zeta1i 0.0)
               (zeta1r 0.0) (zeta2i 0.0) (zeta2r 0.0))
          ...
          (multiple-value-bind
              ...
              (zunik zr zi fn 1 1 tol init phir phii zeta1r zeta1i zeta2r
               zeta2i sumr sumi cwrkr cwrki)
            (declare (ignore var-3 var-4 var-15 var-16))
