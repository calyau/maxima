;;; Compiled by f2cl version 2.0 beta on 2002/04/25 at 13:19:46
;;; 
    ...
    (f2cl-lib:with-array-data (yi-%data% yi-%offset% yi)
      ...
      (f2cl-lib:with-array-data (yr-%data% yr-%offset% yr)
        ...
        (prog ((cwrkr (make-array 16 :element-type 'double-float))
               (cwrki (make-array 16 :element-type 'double-float)) (i 0)
               (idum 0) (iform 0) (init 0) (nn 0) (nw 0) (aarg 0.0) (aphi 0.0)
               (argi 0.0) (argr 0.0) (asumi 0.0) (asumr 0.0) (ascle 0.0)
               (ax 0.0) (ay 0.0) (bsumi 0.0) (bsumr 0.0) (czi 0.0) (czr 0.0)
               (fnn 0.0) (gnn 0.0) (gnu 0.0) (phii 0.0) (phir 0.0) (rcz 0.0)
               (str 0.0) (sti 0.0) (sumi 0.0) (sumr 0.0) (zbi 0.0) (zbr 0.0)
               (zeta1i 0.0) (zeta1r 0.0) (zeta2i 0.0) (zeta2r 0.0) (zni 0.0)
         ...
         label20
          ...
          (multiple-value-bind
            ...
            (declare (ignore var-4 var-15 var-16))
            (when var-0 (setf zrr var-0))
            (when var-1 (setf zri var-1))
            (when var-2 (setf gnu var-2))
            (when var-3 (setf ikflg var-3))
            (when var-5 (setf tol var-5))
            (when var-6 (setf init var-6))
            (when var-7 (setf phir var-7))
            (when var-8 (setf phii var-8))
            (when var-9 (setf zeta1r var-9))
            (when var-10 (setf zeta1i var-10))
            (when var-11 (setf zeta2r var-11))
            (when var-12 (setf zeta2i var-12))
            (when var-13 (setf sumr var-13))
            (when var-14 (setf sumi var-14)))
         ...
         end_label
          (return
           (values nil nil nil nil ikflg nil nil nil nuf tol nil nil)))))))
