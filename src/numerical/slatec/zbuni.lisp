   ...
   label25
    ...
    (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
      ...
      (tagbody
        ...
        (setf s2i (* s2i csclr))
       label30))
    (f2cl-lib:fset (f2cl-lib:fref yr (n) ((1 n))) (* s2r cscrr))
    (f2cl-lib:fset (f2cl-lib:fref yi (n) ((1 n))) (* s2i cscrr))
    (if (= n 1) (go end_label))
    ...
    (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
      ...
      (tagbody
        ...
        (setf str (* s2r cscrr))
        (setf sti (* s2i cscrr))
        (f2cl-lib:fset (f2cl-lib:fref yr (k) ((1 n))) str)
        (f2cl-lib:fset (f2cl-lib:fref yi (k) ((1 n))) sti)
        (setf fnui (- fnui 1.0))
