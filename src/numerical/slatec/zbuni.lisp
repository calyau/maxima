;;; Compiled by f2cl version 2.0 beta on 2002/04/25 at 13:19:22
;;; 
    ...
    (f2cl-lib:with-array-data (yr-%data% yr-%offset% yr)
      ...
      (prog ((cyr (make-array 2 :element-type 'double-float))
        ...
        (multiple-value-bind
          ...
          (when var-8 (setf nlast var-8))
          (when var-9 (setf fnul var-9))
       ...
       label20
        ...
        (setf str
                (multiple-value-bind
                  ...
                  (declare (ignore))
                  (when var-0
                    (f2cl-lib:fset (f2cl-lib:fref cyr (1) ((1 2))) var-0))
                  (when var-1
                    (f2cl-lib:fset (f2cl-lib:fref cyi (1) ((1 2))) var-1))
                  ret-val))
        ...
        (f2cl-lib:fset (f2cl-lib:fref bry (3) ((1 3)))
                       (f2cl-lib:fref bry (2) ((1 3))))
        (setf iflag 2)
       ...
       label25
        ...
        (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
          ...
          (tagbody
            ...
            (setf str (* s2r cscrr))
            (setf sti (* s2i cscrr))
            (setf c1r (coerce (abs str) 'double-float))
            (setf c1i (coerce (abs sti) 'double-float))
            ...
            (setf s2i (* s2i csclr))
           label30))
        (f2cl-lib:fset (f2cl-lib:fref yr-%data% (n) ((1 n)) yr-%offset%)
                       (* s2r cscrr))
        (f2cl-lib:fset (f2cl-lib:fref yi-%data% (n) ((1 n)) yi-%offset%)
                       (* s2i cscrr))
        (if (= n 1) (go end_label))
       ...
       end_label
        (return
         (values zr zi fnu kode n nil nil nz nil nlast fnul tol elim alim))))))
