;;; Compiled by f2cl version 2.0 beta on 2002/04/25 at 13:19:15
;;; 
...
(let ((pi_ 3.141592653589793)
      ...
      (coner 1.0)
      (conei 0.0))
  (declare (type double-float conei coner zeroi zeror rtpi pi_))
    ...
    (f2cl-lib:with-array-data (yi-%data% yi-%offset% yi)
      ...
      (f2cl-lib:with-array-data (yr-%data% yr-%offset% yr)
        ...
        (prog ((i 0) (ib 0) (il 0) (inu 0) (j 0) (jl 0) (k 0) (koded 0) (m 0)
               (nn 0) (aa 0.0) (aez 0.0) (ak 0.0) (ak1i 0.0) (ak1r 0.0)
               (arg 0.0) (arm 0.0) (atol 0.0) (az 0.0) (bb 0.0) (bk 0.0)
               (cki 0.0) (ckr 0.0) (cs1i 0.0) (cs1r 0.0) (cs2i 0.0) (cs2r 0.0)
               (czi 0.0) (czr 0.0) (dfnu 0.0) (dki 0.0) (dkr 0.0) (dnu2 0.0)
               (ezi 0.0) (ezr 0.0) (fdn 0.0) (p1i 0.0) (p1r 0.0) (raz 0.0)
               (rtr1 0.0) (rzi 0.0) (rzr 0.0) (s 0.0) (sgn 0.0) (sqk 0.0)
               (sti 0.0) (str 0.0) (s2i 0.0) (s2r 0.0) (tzi 0.0) (tzr 0.0))
          (declare
           (type double-float tzr tzi s2r s2i str sti sqk sgn s rzr rzi rtr1
            raz p1r p1i fdn ezr ezi dnu2 dkr dki dfnu czr czi cs2r cs2i cs1r
            cs1i ckr cki bk bb az atol arm arg ak1r ak1i ak aez aa)
            ...
            (tagbody
              ...
              (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                ...
                (tagbody
                  (multiple-value-bind
                    ...
                    (when var-2 (setf dkr var-2))
                    (when var-3 (setf dki var-3))
             ...
             label50
              ...
              (multiple-value-bind
                ...
                (declare (ignore var-0 var-1 var-4 var-5))
                (when var-2 (setf cs2r var-2))
                (when var-3 (setf cs2i var-3)))
              (setf s2r (+ s2r str))
              (setf s2i (+ s2i sti))
             label60
         ...
         label110
          ...
          (go end_label)
         end_label
          (return (values zr zi nil nil nil nil nil nz nil nil nil nil)))))))
