;;; Compiled by f2cl version 2.0 beta on 2002/04/25 at 13:19:18
;;; 
...
(let ((kmax 30)
  ...
  (f2cl-lib:fset (f2cl-lib:fref cc (4) ((1 8))) 0.007218943246663099)
  (f2cl-lib:fset (f2cl-lib:fref cc (5) ((1 8))) -2.1524167411495104e-4)
  (f2cl-lib:fset (f2cl-lib:fref cc (6) ((1 8))) -2.013485478078824e-5)
  (f2cl-lib:fset (f2cl-lib:fref cc (7) ((1 8))) 1.1330272319816956e-6)
  (f2cl-lib:fset (f2cl-lib:fref cc (8) ((1 8))) 6.116095104481417e-9)
    ...
    (f2cl-lib:with-array-data (yi-%data% yi-%offset% yi)
      ...
      (f2cl-lib:with-array-data (yr-%data% yr-%offset% yr)
        ...
        (prog ((cssr (make-array 3 :element-type 'double-float))
               ...
               (cchr 0.0) (cki 0.0) (ckr 0.0) (coefi 0.0) (coefr 0.0)
               (crscr 0.0) (csclr 0.0) (cshi 0.0) (cshr 0.0) (csi 0.0)
               (csr 0.0) (czi 0.0) (czr 0.0) (dnu 0.0) (dnu2 0.0) (etest 0.0)
               (fc 0.0) (fhs 0.0) (fi 0.0) (fk 0.0) (fks 0.0) (fmui 0.0)
               (fmur 0.0) (fr 0.0) (g1 0.0) (g2 0.0) (pi_ 0.0) (pr 0.0)
               (pti 0.0) (ptr 0.0) (p1i 0.0) (p1r 0.0) (p2i 0.0) (p2m 0.0)
               (p2r 0.0) (qi 0.0) (qr 0.0) (rak 0.0) (rcaz 0.0) (rzi 0.0)
               (rzr 0.0) (s 0.0) (smui 0.0) (smur 0.0) (sti 0.0) (str 0.0)
               (s1i 0.0) (s1r 0.0) (s2i 0.0) (s2r 0.0) (tm 0.0) (t1 0.0)
          ...
          (declare (type (simple-array double-float (2)) cyi cyr)
                   ...
                   (type double-float helim alas as zdi zdr celmr elm t2 t1 tm
                    ...
                    p2r p2m p2i p1r p1i ptr pti pr pi_ g2 g1 fr fmur fmui fks
                    fk fi fhs fc etest dnu2 dnu czr czi csr csi cshr cshi csclr
          ...
          (multiple-value-bind
            ...
            (when var-2 (setf smur var-2))
            (when var-3 (setf smui var-3))
          ...
          (multiple-value-bind
            ...
            (declare (ignore))
            (when var-0 (setf fmur var-0))
            (when var-1 (setf fmui var-1))
            (when var-2 (setf cshr var-2))
            (when var-3 (setf cshi var-3))
            (when var-4 (setf cchr var-4))
            (when var-5 (setf cchi var-5)))
         ...
         label50
          ...
          (multiple-value-bind
            ...
            (when var-2 (setf str var-2))
            (when var-3 (setf sti var-3))
            (when var-4 (setf ptr var-4))
            (when var-5 (setf pti var-5)))
          (setf qr (/ ptr t1))
          (setf qi (/ pti t1))
          (setf s1r fr)
          (setf s1i fi)
         ...
         label70
          (f2cl-lib:fset (f2cl-lib:fref yr-%data% (1) ((1 n)) yr-%offset%) s1r)
          (f2cl-lib:fset (f2cl-lib:fref yi-%data% (1) ((1 n)) yi-%offset%) s1i)
         ...
         label100
          ...
          (multiple-value-bind
            ...
            (when var-2 (setf rzr var-2))
            (when var-3 (setf rzi var-3))
            (when var-4 (setf s2r var-4))
            (when var-5 (setf s2i var-5)))
          (setf s1r (* s1r str))
          (setf s1i (* s1i str))
         ...
         label110
          ...
          (multiple-value-bind
            ...
            (declare (ignore))
            (when var-0 (setf rthpi var-0))
            (when var-1 (setf czeroi var-1))
            (when var-2 (setf str var-2))
            (when var-3 (setf sti var-3))
            (when var-4 (setf coefr var-4))
            (when var-5 (setf coefi var-5)))
          (setf kflag 2)
         ...
         label180
          ...
          (multiple-value-bind
            ...
            (when var-4 (setf s1r var-4))
            (when var-5 (setf s1i var-5)))
         ...
         label200
          ...
          (multiple-value-bind
            ...
            (when var-2 (setf p2r var-2))
            (when var-3 (setf p2i var-3))
            (when var-4 (setf ptr var-4))
            (when var-5 (setf pti var-5)))
          ...
          (multiple-value-bind
            ...
            (declare (ignore var-0 var-1 var-4 var-5))
            (when var-2 (setf zr var-2))
            (when var-3 (setf zi var-3)))
          (setf str (+ str 1.0))
          (multiple-value-bind
              (var-0 var-1 var-2 var-3 var-4 var-5)
         ...
         label240
          ...
          (f2cl-lib:fset (f2cl-lib:fref yi-%data% (1) ((1 n)) yi-%offset%)
                         (* s1i str))
          (if (= n 1) (go end_label))
          (f2cl-lib:fset (f2cl-lib:fref yr-%data% (2) ((1 n)) yr-%offset%)
                         (* s2r str))
          (f2cl-lib:fset (f2cl-lib:fref yi-%data% (2) ((1 n)) yi-%offset%)
                         (* s2i str))
          (if (= n 2) (go end_label))
          (setf kk 2)
         label250
         ...
         label270
          ...
          (f2cl-lib:fset (f2cl-lib:fref yi-%data% (1) ((1 n)) yi-%offset%) s1i)
          (if (= n 1) (go label280))
          (f2cl-lib:fset (f2cl-lib:fref yr-%data% (2) ((1 n)) yr-%offset%) s2r)
          (f2cl-lib:fset (f2cl-lib:fref yi-%data% (2) ((1 n)) yi-%offset%) s2i)
         label280
          (setf ascle (f2cl-lib:fref bry (1) ((1 3))))
          (multiple-value-bind
            ...
            (when var-0 (setf zdr var-0))
            (when var-1 (setf zdi var-1))
            (when var-2 (setf fnu var-2))
            (when var-3 (setf n var-3))
            (when var-6 (setf nz var-6))
            (when var-7 (setf rzr var-7))
            (when var-8 (setf rzi var-8))
            (when var-9 (setf ascle var-9))
          ...
          (f2cl-lib:fset (f2cl-lib:fref yr-%data% (kk) ((1 n)) yr-%offset%)
                         (* s1r (f2cl-lib:fref csrr (1) ((1 3)))))
          (f2cl-lib:fset (f2cl-lib:fref yi-%data% (kk) ((1 n)) yi-%offset%)
         ...
         label310
          ...
          (go end_label)
         end_label
          (return (values zr zi fnu nil n nil nil nz tol elim nil)))))))
