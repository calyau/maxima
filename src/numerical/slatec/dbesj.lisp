;;; Compiled by f2cl version 2.0 beta on 2002/04/26 at 09:38:37
;;; 
  ...
  (defun dbesj (x alpha n y nz)
    ...
    (f2cl-lib:with-array-data (y-%data% y-%offset% y)
      ...
      (prog ((temp (make-array 3 :element-type 'double-float))
             ...
             (tfn 0.0) (tm 0.0) (tol 0.0) (tolln 0.0) (trx 0.0) (tx 0.0)
             (t1 0.0) (t2 0.0) (xo2 0.0) (xo2l 0.0) (slim 0.0) (rtol 0.0) (i 0)
             (ialp 0) (idalp 0) (iflw 0) (in 0) (is 0) (i1 0) (i2 0) (k 0)
             (kk 0) (km 0) (kt 0) (nn 0) (ns 0) (t_ 0.0))
        (declare
       ...
       label130
        ...
        (multiple-value-bind
          ...
          (declare (ignore var-0 var-5 var-6))
          (when var-1 (setf x var-1))
          (when var-2 (setf fn var-2))
          (when var-3 (setf flgjy var-3))
          (when var-4 (setf i1 var-4))
          (when var-7 (setf iflw var-7)))
       ...
       label450
        ...
        (setf nz (f2cl-lib:int-sub n nn))
        (if (= kt 2) (go label470))
        (f2cl-lib:fset (f2cl-lib:fref y-%data% (nn) ((1 t)) y-%offset%)
       ...
       label455
        ...
        (f2cl-lib:fdo (i 3 (f2cl-lib:int-add i 1))
          ...
          (tagbody
            ...
            (setf tb (- (* tm tb) ta))
            (setf ta s)
            (f2cl-lib:fset (f2cl-lib:fref y-%data% (k) ((1 t)) y-%offset%)
                           (* tb ak))
            (setf dtm (- dtm 1.0))
            (setf tm (* (+ dtm fnf) trx))
       ...
       label520
        ...
        (f2cl-lib:fdo (k 1 (f2cl-lib:int-add k 1))
          ...
          (tagbody
           ...
           label530))
       label540
        (f2cl-lib:fset (f2cl-lib:fref temp (is) ((1 3)))
                       (* coef (- (* s1 sb) (* s2 sa))))
        (if (= is 2) (go label560))
       ...
       label560
        ...
        (setf s1 s)
       label580
        (f2cl-lib:fset (f2cl-lib:fref y-%data% (1) ((1 t)) y-%offset%) s1)
        (f2cl-lib:fset (f2cl-lib:fref y-%data% (2) ((1 t)) y-%offset%) s2)
        (if (= nn 2) (go end_label))
        (f2cl-lib:fdo (i 3 (f2cl-lib:int-add i 1))
                      ((> i nn) nil)
          (tagbody
            (f2cl-lib:fset (f2cl-lib:fref y-%data% (i) ((1 t)) y-%offset%)
                           (-
                            (* tm
        ...
        (go end_label)
       label600
        (f2cl-lib:fset (f2cl-lib:fref y-%data% (1) ((1 t)) y-%offset%) s2)
        (go end_label)
       label610
       ...
       label730
        ...
        (go end_label)
       end_label
        (return (values x nil nil nil nz))))))
