...
SBCL is usually faster, but there were issues with DEP (data execution prevention) reported. Due to memory problems, some packages (e.g. Lapack) will not work.
