...
\chapter{Available Interfaces to Maxima}
  \input{interfaces/interfaces.tex}
...
\chapter{Introduction to Maxima's Programming Language}
  \input{programming/prog.tex}


\chapter{Graphics and Forms of Output}

  \input{output/output.tex}

\chapter{Maxims for the Maxima User}
  \input{maxims/maxims.tex}
...
\chapter{Calculus}
   ...
   \section{asympa}
%   \input{share/calculus/asympa.tex}
   \pagebreak
   \section{pdiff - Positional Derivatives}
   \input{share/calculus/pdiff.tex}
   \pagebreak
   \section{qual}
%   \input{share/calculus/qual.tex}   
