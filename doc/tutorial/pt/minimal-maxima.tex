...
Manual de referência: \url{http://maxima.sourceforge.net/docs/manual/en/maxima.html}}
...
\item Partinfo do Lisp, a construção $(\mathbf{mfuncall\ '\$}\mathrm{foo\ }a_1 \ldots a_n)$
chama a função $\mathbf{foo}$ definida no Maxima.
