...
%
% This texinfo.tex is based on the version 2020-10-24.12
% from the GNU website, but contains a patch from Leo Butler
% to solve an issue with the generation of our PDF documentation.
% See: https://sourceforge.net/p/maxima/mailman/message/37181353/
% and: https://sourceforge.net/p/maxima/mailman/message/37181827/
% 
% Load plain if necessary, i.e., if running under initex.
\expandafter\ifx\csname fmtname\endcsname\relax\input plain\fi
%
\def\texinfoversion{2021-01-14.14}
%
...
\def\xrefX[#1,#2,#3,#4,#5,#6]{\begingroup
  ...
  \else
    ...
    \else
      ...
      \ifrefincludespage
      % We always want a comma and a space:
      ,\space
      %
      % output the `page 3'.
