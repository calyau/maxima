...
% an actual _ character, as in @math{@mvar{some_variable} + 1}.  So make
...
% @deftypefun int foobar (int @mvar{foo}, float @mvar{bar})
...
% @deftypefn {Library Function} int foobar (int @mvar{foo}, float @mvar{bar})
