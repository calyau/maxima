...
(apply 'in-package "MAKE" :use '( "LISP") #-akcl nil
       #+akcl '(:external 11 :internal 79))
...
the :object-path property of SYSTEM.  Similarly for :source-path"
  ...
  (cond ((symbolp system)
	...
	(t (setf files system)))
  #+akcl (when proclaims (compiler::emit-fn t) (compiler::setup-sys-proclaims))
