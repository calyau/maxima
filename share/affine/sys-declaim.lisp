...
(DECLAIM (FTYPE (FUNCTION (T T T T T) *) MAXIMA::HENSEL-LIFT))
(DECLAIM
...
(DECLAIM (FTYPE (FUNCTION (T T T T T *) T) MAXIMA::HENSEL-LIFT1))
(DECLAIM
...
(DECLAIM (FTYPE (FUNCTION (T T T T T) T) MAXIMA::PSUBLIS1))
(DECLAIM
...
(DECLAIM (FTYPE (FUNCTION NIL *) MAXIMA::SAVE-BLEW-UP))
(DECLAIM
    (FTYPE (FUNCTION (*) *) MAXIMA::POLY-NCMUL MAXIMA::$CIRCLE_TIMES
	    ...
	    MAXIMA::VADD* MAXIMA::VMUL* #-cl MAXIMA::CREATE-SPARSE-MATRIX
...
|#
(declaim (special
	  $NEW_FAST_DOTSIMP *POLY-SIMPLIFICATIONS* *SIMPLIFY-RHS*
	  *MUST-REPLACE-DATA* *XXX* $RELATIONSB *IN-LINEAR-DICH*
	  *ALL-DOTSIMP-DENOMS* $BIL $DENOMS))
