		   ...
		   (let ((obj (caddar p)))
		     (and (mexptp obj)
			  ...
			  (let ((inquir-expon (caddr obj)))
			    (let ((both-fix (and nstate (fixnump inquir-expon))))
