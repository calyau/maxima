...
(defun gsub (i z g)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ()
      (declare)
      (f2cl-lib:computed-goto (label10 label20 label30 label40 label30) i)
     label10
      (setf g (f2cl-lib:fref z-%data% (1) ((1 1)) z-%offset%))
      (go end_label)
     label20
      (setf g (f2cl-lib:fref z-%data% (3) ((1 1)) z-%offset%))
      (go end_label)
     label30
      (setf g (f2cl-lib:fref z-%data% (4) ((1 1)) z-%offset%))
      (go end_label)
     label40
      (setf g (- (f2cl-lib:fref z-%data% (1) ((1 1)) z-%offset%) 1.0f0))
      (go end_label)
     end_label
