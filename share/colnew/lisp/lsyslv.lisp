      ...
      (f2cl-lib:with-multi-array-data
       ...
       (prog ((izet 0) (iz 0) (value 0.0) (jj 0) (xcol 0.0) (hrho 0.0) (j 0)
         ...
         (declare (type (array double-float (40)) zval f dgz)
                  ...
                  (type (f2cl-lib:integer4) m1 i idmz idmzo irhs ig iw iv lside
                                            iold ncol nrow lw l j jj iz izet))
         (setf m1 (f2cl-lib:int-add mode 1))
         (f2cl-lib:computed-goto (label10 label30 label30 label30 label310) m1)
        label10
         (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                       ((> i mstar) nil)
                       (tagbody
                        label20
                         (setf (f2cl-lib:fref zval (i) ((1 40))) 0.0)))
        label30
         (setf idmz 1)
         (setf idmzo 1)
         (setf irhs 1)
        ...
        label80
         ...
         (f2cl-lib:fdo (l 1 (f2cl-lib:int-add l 1))
                       ...
                       (tagbody
                        label84
                         (setf (f2cl-lib:fref w-%data% (l) ((1 1)) w-%offset%)
                                 0.0)))
        label90
         (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                       ((> i n) nil)
                       (tagbody
                        ...
                        label102
                         ...
                         (multiple-value-bind
                               (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7
                                ...
                                var-15 var-16)
                             (approx iold xii zval at coef xiold nold z dmz k
                              ncomp mmax m mstar 2 dummy 0)
                           (declare (ignore var-2 var-3 var-4 var-5 var-6 var-7
                        ...
                        label106
                         (multiple-value-bind
                               (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7
                                var-8 var-9 var-10 var-11 var-12 var-13 var-14
                                var-15 var-16)
                             (approx i xii zval at dummy xi n z dmz k ncomp
                        ...
                        label120
                         (gderiv
                          (f2cl-lib:array-slice g double-float (ig) ((1 1)))
                                       ...
                                       (tagbody
                                        ...
                                        label160
                                         ...
                                         (multiple-value-bind
                                             ...
                                             (approx iold xcol zval at coef
                                              xiold nold z dmz k ncomp mmax m
                                              mstar 2
                                         ...
                                         (multiple-value-bind
                                             ...
                                             (approx i xcol zval
                                              (f2cl-lib:array-slice acol
                                                                    ...
                                                                    ((1 28)
                                                                     (1 7)))
                                              coef xi n z dmz k ncomp mmax m
                                              mstar 4 dummy 0)
                                           (declare (ignore var-2 var-3 var-4
                                                            var-5 var-6 var-7
                                                            var-8 var-9 var-10
                        ...
                        label245
                         ...
                         (multiple-value-bind
                               (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7
                                var-8 var-9 var-10 var-11 var-12 var-13 var-14
                                var-15 var-16)
                             (approx (f2cl-lib:int-add nold 1) aright zval at
                              coef xiold nold z dmz k ncomp mmax m mstar 1
                              dummy 0)
                        ...
                        label246
                         (multiple-value-bind
                               (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7
                                var-8 var-9 var-10 var-11 var-12 var-13 var-14
                                var-15 var-16)
                             (approx (f2cl-lib:int-add n 1) aright zval at coef
                              xi n z dmz k ncomp mmax m mstar 1 dummy 0)
                           (declare (ignore var-0 var-2 var-3 var-4 var-5 var-6
                                            var-7 var-8 var-9 var-10 var-11
                                            var-12 var-13 var-14 var-15
                                            var-16))
        ...
        label310
         (f2cl-lib:fdo (l 1 (f2cl-lib:int-add l 1))
                       ((> l ndmz) nil)
                       (tagbody
                         (setf (f2cl-lib:fref deldmz-%data%
                                              (l)
                                              ((1 1))
                                              deldmz-%offset%)
                       ...
                       (tagbody
                         (setf nrow
                                 (f2cl-lib:fref integs-%data%
                                                ...
                                                integs-%offset%))
                         (setf izeta
                                 (f2cl-lib:int-sub (f2cl-lib:int-add nrow 1)
                                                   mstar))
                         ...
                         (setf h
                                 (-
                                  ...
                                  (f2cl-lib:fref xi-%data%
                                                 ...
                                                 xi-%offset%)))
                         (gblock h
                          (f2cl-lib:array-slice g double-float (1) ((1 1)))
                          nrow izeta
                       ...
                       (tagbody
                        ...
                        label340
                         ...
                         (gblock h
                          (f2cl-lib:array-slice g double-float (1) ((1 1)))
                          nrow izeta
                          (f2cl-lib:array-slice w double-float (iw) ((1 1))) df
                          kd (f2cl-lib:array-slice z double-float (iz) ((1 1)))
                          (f2cl-lib:array-slice dmz
                                                double-float
                                                (idmz)
                                                ((1 1)))
                          (f2cl-lib:array-slice ipvtw
