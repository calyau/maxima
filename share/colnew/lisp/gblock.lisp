  ...
  (let ((colord-m
    ...
    (symbol-macrolet ((k (aref (colord-part-0 *colord-common-block*) 0))
      ...
      (f2cl-lib:with-multi-array-data
       ...
       (prog ((jcomp 0) (ll 0) (jd 0) (rsum 0.0) (ind 0) (jcol 0) (id 0) (mj 0)
              (icomp 0) (ir 0) (j 0) (l 0) (fact 0.0)
                       ...
                       (tagbody
                         ...
                         (f2cl-lib:fdo (l 1 (f2cl-lib:int-add l 1))
                                       ...
                                       (tagbody
                                         ...
                                         (f2cl-lib:fdo
                                          (jcol 1 (f2cl-lib:int-add jcol 1))
                                          ((> jcol mstar) nil)
                                          (tagbody
                                            (setf ind icomp)
                                            (setf rsum 0.0)
