  ...
  (let ((colord-m
    ...
    (symbol-macrolet ((ncomp (aref (colord-part-0 *colord-common-block*) 1))
      ...
      (f2cl-lib:with-multi-array-data
       ...
       (prog ((np1 0) (idmz 0) (mj 0) (scal 0.0) (icomp 0) (l 0) (h 0.0) (iz 0)
              (j 0) (basm (make-array 5 :element-type 'double-float)))
