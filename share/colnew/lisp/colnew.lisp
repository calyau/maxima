               ...
               (f2cl-lib:with-multi-array-data
                ...
                (prog ((ic 0) (k2 0) (idmz 0) (np1 0) (linteg 0) (lpvtw 0)
                  ...
                  (declare (type (array double-float (1)) dummy)
                           ...
                           (type (f2cl-lib:integer4) i iread ndimf ndimi nfxpnt
                                                     ip nrec ib nfixi nsizei
                                                     nfixf nsizef nmaxf nmaxi
                                                     lxi lg lxiold lw lv lz
                                                     ldmz ldelz ldeldz ldqz
                 ...
                 colsys
                  (if
                   (<= (f2cl-lib:fref ipar-%data% (7) ((1 1)) ipar-%offset%) 0)
                   (f2cl-lib:fformat 6
                                     ("~%" "~%"
                  ...
                  (f2cl-lib:fformat iout
                                    ...
                                    (do ((ip 1 (f2cl-lib:int-add ip 1))
                                      ...
                                      (push
                                       ...
                                       %ret)))
                  (f2cl-lib:fformat iout
                                    (" CORRESPONDING ERROR TOLERANCES -" "~6@T"
                                     8 (("~10,2,2,0,'*,,'DE")) 4
                                     ("~%" "~39@T" 8 (("~10,2,2,0,'*,,'DE")))
                                     "~%")
                                    (do ((ip 1 (f2cl-lib:int-add ip 1))
                          ...
                          (f2cl-lib:int-add ldelz
                                            (f2cl-lib:int-mul mstar
                                                              (f2cl-lib:int-add
                                                               ...
                                                               1))))
                  (setf ldqz
                          (f2cl-lib:int-add ldeldz (f2cl-lib:int-mul kd nmax)))
                  (setf ldqdmz
                          (f2cl-lib:int-add ldqz
                                            (f2cl-lib:int-mul mstar
                                                              (f2cl-lib:int-add
                                                               ...
                                                               1))))
                  (setf lrhs
                          (f2cl-lib:int-add ldqdmz (f2cl-lib:int-mul kd nmax)))
                  (setf lvalst
