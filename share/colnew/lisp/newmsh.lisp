        ...
        label50
         ...
         (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                       ...
                       (tagbody
                         ...
                         (if
                          (> nmin
                             (f2cl-lib:int-add (f2cl-lib:int-sub n nfxpnt) j))
                          (setf nmin
                                  (f2cl-lib:int-add (f2cl-lib:int-sub n nfxpnt)
                                                    j)))
                         (setf iright
                                 (f2cl-lib:max0 (f2cl-lib:int-add ileft 1)
                                                nmin))
                        label60
                         (setf (f2cl-lib:fref xi-%data%
                                              (iright)
                         ...
                         (multiple-value-bind
                             ...
                             (approx i x
                              ...
                              (f2cl-lib:array-slice asave
                                                    ...
                                                    (1 1)
                                                    ((1 28) (1 4)))
                              dummy xiold nold z dmz k ncomp mmax m mstar 4
                              dummy 0)
                                         ...
                                         (multiple-value-bind
                                             ...
                                             (approx i x
                                              ...
                                              (f2cl-lib:array-slice asave
                                                                    ...
                                                                    ((1 28)
                                                                     (1 4)))
                                              dummy xiold nold z dmz k ncomp
                                              mmax m mstar 4 dummy 0)
