...
(defun dpkset (neq y ysv ewt ftem savf wm iwm f jac)
  (declare (type (array double-float (*)) wm savf ftem ewt ysv y)
          ...
          (multiple-value-bind
              ...
              (funcall jac
                       ...
                       (f2cl-lib:array-slice iwm-%data%
                                             ...
                                             iwm-%offset%)
                       ier)
            (declare (ignore var-0 var-1 var-3 var-4 var-5 var-6 var-7 var-9
                             var-10))
            (when var-2
              (setf tn var-2))
            (when var-8
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dpkset
