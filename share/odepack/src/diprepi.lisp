...
(defun diprepi (neq y s rwork ia ja ic jc ipflag res jac adda)
  (declare (type (f2cl-lib:integer4) ipflag)
           (type (array double-float (*)) rwork s y)
           (type (array f2cl-lib:integer4 (*)) jc ic ja ia neq))
  (let ()
    (symbol-macrolet ((lyh (aref (dls001-part-1 *dls001-common-block*) 19))
      ...
      (f2cl-lib:with-multi-array-data
        ...
        (prog ((lyhn 0) (lyhd 0) (lewtn 0) (imax 0) (i 0))
         ...
         end_label
          (return
           (values nil nil nil nil nil nil nil nil ipflag nil nil nil)))))))

(in-package #-gcl #:cl-user #+gcl "CL-USER")
#+#.(cl:if (cl:find-package '#:f2cl) '(and) '(or))
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::diprepi
          ...
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :return-values '(nil nil nil nil nil nil nil nil
                            fortran-to-lisp::ipflag nil nil nil)
           :calls '(fortran-to-lisp::dprepi))))
