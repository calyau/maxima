...
(let ((lenrls 218) (lenils 37) (lenrla 22) (lenila 9))
  (declare (type (f2cl-lib:integer4) lenrls lenils lenrla lenila))
  (defun dsrcma (rsav isav job)
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dsrcma
