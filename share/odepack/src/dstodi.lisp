...
(defun dstodi
       (neq y yh nyh yh1 ewt savf savr acor wm iwm res adda jac pjac slvs)
  (declare (type (f2cl-lib:integer4) nyh)
           (type (array double-float (*)) wm acor savr savf ewt yh1 yh y)
  ...
  (let ((dls001-el
    ...
    (symbol-macrolet ((conit (aref (dls001-part-0 *dls001-common-block*) 0))
      ...
      (f2cl-lib:with-multi-array-data
        ...
        (prog ((newq 0) (ncf 0) (m 0) (kgo 0) (jb 0) (j 0) (iret 0) (ires 0)
               (iredo 0) (i1 0) (i 0) (told 0.0d0) (rhup 0.0d0) (rhsm 0.0d0)
               (rhdn 0.0d0) (rh 0.0d0) (r 0.0d0) (exup 0.0d0) (exsm 0.0d0)
               (exdn 0.0d0) (el1h 0.0d0) (eljh 0.0d0) (dup 0.0d0) (dsm 0.0d0)
               (delp 0.0d0) (del 0.0d0) (ddn 0.0d0) (dcon 0.0d0))
          (declare (type (double-float) dcon ddn del delp dsm dup eljh el1h
                                        exdn exsm exup r rh rhdn rhsm rhup
                                        told)
                   (type (f2cl-lib:integer4) i i1 iredo ires iret j jb kgo m
                                             ncf newq))
          (setf kflag 0)
          (setf told tn)
          (setf ncf 0)
         ...
         label220
          ...
          (setf nslp nst)
          (setf crate 0.7d0)
          (if (= ierpj 0) (go label250))
          (if (< ierpj 0) (go label435))
          (setf ires ierpj)
          (f2cl-lib:computed-goto (label430 label435 label430) ires)
         label240
          (setf ires 1)
          (multiple-value-bind (var-0 var-1 var-2 var-3 var-4 var-5)
              (funcall res neq tn y savf savr ires)
          ...
          (setf kgo (abs ires))
          (f2cl-lib:computed-goto (label250 label435 label430) kgo)
         label250
          (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                        ((> i n) nil)
            (tagbody
             label260
              (setf (f2cl-lib:fref acor-%data% (i) ((1 *)) acor-%offset%)
                      0.0d0)))
         label270
          (funcall slvs wm iwm savr savf)
          (if (< iersl 0) (go label430))
          (if (> iersl 0) (go label410))
          (setf el1h (* (f2cl-lib:fref el (1) ((1 13))) h))
          (setf del (* (dvnorm n savr ewt) (abs h)))
          (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                        ((> i n) nil)
            (tagbody
              (setf (f2cl-lib:fref acor-%data% (i) ((1 *)) acor-%offset%)
          ...
          (setf nfe (f2cl-lib:int-add nfe 1))
          (setf kgo (abs ires))
          (f2cl-lib:computed-goto (label270 label435 label410) kgo)
         label410
          (setf icf 1)
          (if (= jcur 1) (go label430))
          (setf ipup miter)
          (go label220)
         label430
          (setf icf 2)
                  ...
                  (setf (f2cl-lib:fref yh1-%data% (i) ((1 *)) yh1-%offset%)
                          (-
                           ...
                           (f2cl-lib:fref yh1-%data%
                                          ...
                                          yh1-%offset%)))))
             label445))
          (if (= ires 2) (go label680))
          (if (or (< ierpj 0) (< iersl 0)) (go label685))
          (if (<= (abs h) (* hmin 1.00001d0)) (go label450))
          (if (= ncf mxncf) (go label450))
          (setf rh 0.25d0)
          (setf ipup miter)
          (setf iredo 1)
          (go label170)
         label450
          (if (= ires 3) (go label680))
          (go label670)
         label460
          (setf jcur 0)
          (if (= m 0)
          ...
          (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                        ((> j l) nil)
            (tagbody
              (setf eljh (* (f2cl-lib:fref el (j) ((1 13))) h))
              (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                            ((> i n) nil)
                (tagbody
                  (setf (f2cl-lib:fref yh-%data%
         ...
         label590
          ...
          (setf r (/ (* h (f2cl-lib:fref el (l) ((1 13)))) l))
          (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                        ((> i n) nil)
            (tagbody
             label600
         ...
         label620
          ...
          (if (<= kflag -2) (setf rh (min rh 0.1d0)))
         ...
         label670
          ...
          (go label720)
         label680
          (setf kflag (f2cl-lib:int-sub (f2cl-lib:int-sub ires) 1))
          (go label720)
         label685
          (setf kflag -5)
          (go label720)
         label690
          (setf rmax 10.0d0)
         label700
          (setf r (/ h (f2cl-lib:fref tesco (2 nqu) ((1 3) (1 12)))))
          (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                        ((> i n) nil)
            (tagbody
             label710
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dstodi
          ...
          (fortran-to-lisp::make-f2cl-finfo
           :arg-types '((array fortran-to-lisp::integer4 (*))
                        ...
                        (array double-float (*)) (array double-float (*))
                        (array double-float (*))
                        (array fortran-to-lisp::integer4 (*)) t t t t t)
