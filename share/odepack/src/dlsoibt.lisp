    ...
    (let ()
      (symbol-macrolet ((ccmax
        ...
        (f2cl-lib:with-multi-array-data
          ...
          (prog ((nb 0) (mb 0) (lyd0 0) (lp 0) (lenwm 0) (lenrw 0) (leniw 0)
           ...
           label25
            ...
            (setf mb (f2cl-lib:fref iwork-%data% (1) ((1 liw)) iwork-%offset%))
            (setf nb (f2cl-lib:fref iwork-%data% (2) ((1 liw)) iwork-%offset%))
            (if (or (< mb 1) (> mb n)) (go label609))
            (if (< nb 4) (go label610))
            (if (/= (f2cl-lib:int-mul mb nb) n) (go label609))
            ...
            (setf lwm
                    (f2cl-lib:int-add lyh
                                      (f2cl-lib:int-mul
                                       ...
                                       nyh)))
            (setf lenwm (f2cl-lib:int-add (f2cl-lib:int-mul 3 mb mb nb) 2))
            ...
            (multiple-value-bind
                ...
                (daigbt res adda neq t$ y
                 ...
                 (f2cl-lib:array-slice iwork-%data%
                                       ...
                                       iwork-%offset%)
                 ier)
              (declare (ignore var-0 var-1 var-2 var-4 var-5 var-8 var-9))
              (setf t$ var-3)
              (setf mb var-6)
              (setf nb var-7)
              (setf ier var-10))
           ...
           label510
            (setf ewti
                    (f2cl-lib:fref rwork-%data%
                                   ...
                                   rwork-%offset%))
            (f2cl-lib:f2cl-set-string msg
                                      "DLSOIBT- At T (=R1), EWT(I1) has become R2  <=  0."
                                      (string 60))
           ...
           label603
            (f2cl-lib:f2cl-set-string msg
                                      "DLSOIBT- ISTATE > 1 but DLSOIBT not initialized. "
                                      (string 60))
           ...
           label609
            (f2cl-lib:f2cl-set-string msg
                                      ...
                                      (string 60))
            (xerrwd msg 40 9 0 2 mb nb 0 0.0d0 0.0d0)
            (go label700)
           label610
            (f2cl-lib:f2cl-set-string msg
                                      "DLSOIBT- NB (=I1)  <  4 illegal.       "
                                      (string 60))
            (xerrwd msg 40 10 0 1 nb 0 0 0.0d0 0.0d0)
            (go label700)
           label611
            (f2cl-lib:f2cl-set-string msg
                                      "DLSOIBT- MAXORD (=I1)  <  0  "
           ...
           label619
            (f2cl-lib:f2cl-set-string msg
                                      "DLSOIBT- RTOL(=I1) is R1  <  0.0       "
                                      (string 60))
            (xerrwd msg 40 19 0 1 i 0 1 rtoli 0.0d0)
            (go label700)
           label620
            (f2cl-lib:f2cl-set-string msg
                                      "DLSOIBT- ATOL(=I1) is R1  <  0.0       "
                                      (string 60))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dlsoibt
          ...
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :calls '(fortran-to-lisp::dstodi fortran-to-lisp::xerrwd
                    ...
                    fortran-to-lisp::dewset fortran-to-lisp::daigbt))))
