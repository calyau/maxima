...
(defun dcfode (meth elco tesco)
  ...
  (f2cl-lib:with-multi-array-data
      ((elco double-float elco-%data% elco-%offset%)
       (tesco double-float tesco-%data% tesco-%offset%))
    (prog ((pc (make-array 12 :element-type 'double-float)) (agamq 0.0d0)
           (fnq 0.0d0) (fnqm1 0.0d0) (pint 0.0d0) (ragq 0.0d0) (rqfac 0.0d0)
           (rq1fac 0.0d0) (tsign 0.0d0) (xpin 0.0d0) (i 0) (ib 0) (nq 0)
           (nqm1 0) (nqp1 0))
      (declare (type (f2cl-lib:integer4) nqp1 nqm1 nq ib i)
               (type (array double-float (12)) pc)
               (type (double-float) xpin tsign rq1fac rqfac ragq pint fnqm1 fnq
                                    agamq))
      (f2cl-lib:computed-goto (label100 label200) meth)
     label100
      (setf (f2cl-lib:fref elco-%data% (1 1) ((1 13) (1 12)) elco-%offset%)
              1.0d0)
      (setf (f2cl-lib:fref elco-%data% (2 1) ((1 13) (1 12)) elco-%offset%)
              1.0d0)
      (setf (f2cl-lib:fref tesco-%data% (1 1) ((1 3) (1 12)) tesco-%offset%)
              0.0d0)
      (setf (f2cl-lib:fref tesco-%data% (2 1) ((1 3) (1 12)) tesco-%offset%)
              2.0d0)
      (setf (f2cl-lib:fref tesco-%data% (1 2) ((1 3) (1 12)) tesco-%offset%)
              1.0d0)
      (setf (f2cl-lib:fref tesco-%data% (3 12) ((1 3) (1 12)) tesco-%offset%)
              0.0d0)
      (setf (f2cl-lib:fref pc (1) ((1 12))) 1.0d0)
      (setf rqfac 1.0d0)
      (f2cl-lib:fdo (nq 2 (f2cl-lib:int-add nq 1))
        ...
        (tagbody
          ...
          (setf (f2cl-lib:fref pc (nq) ((1 12))) 0.0d0)
          ...
          (setf xpin (/ (f2cl-lib:fref pc (1) ((1 12))) 2.0d0))
          (setf tsign 1.0d0)
          ...
          (setf ragq (/ 1.0d0 agamq))
          (setf (f2cl-lib:fref tesco-%data%
                               (2 nq)
                               ((1 3) (1 12))
                               tesco-%offset%)
                  ragq)
     ...
     label200
      ...
      (f2cl-lib:fdo (nq 1 (f2cl-lib:int-add nq 1))
        ...
        (tagbody
          ...
          (setf nqp1 (f2cl-lib:int-add nq 1))
          (setf (f2cl-lib:fref pc (nqp1) ((1 12))) 0.0d0)
          (f2cl-lib:fdo (ib 1 (f2cl-lib:int-add ib 1))
                        ((> ib nq) nil)
            (tagbody
