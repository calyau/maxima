...
(defun nntc (n r c il jl ijl l d iu ju iju u z b tmp)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((tmpk 0.0d0) (sum 0.0d0) (ml 0) (i 0) (j 0) (mu 0) (jmax 0) (jmin 0)
           (k 0))
      (declare (type (f2cl-lib:integer4) k jmin jmax mu j i ml)
          ...
          (setf jmax
                  (f2cl-lib:int-sub
                   (f2cl-lib:fref iu-%data%
                                  ...
                                  iu-%offset%)
                   1))
          (setf tmpk (- (f2cl-lib:fref tmp-%data% (k) ((1 *)) tmp-%offset%)))
      ...
      (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
        ...
        (tagbody
         ...
         label5
          (setf (f2cl-lib:fref tmp-%data% (k) ((1 *)) tmp-%offset%)
                  (* (- sum) (f2cl-lib:fref d-%data% (k) ((1 *)) d-%offset%)))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::nntc fortran-to-lisp::*f2cl-function-info*)
