...
(defun cfft2i (l m wsave lensav ier)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((ier1 0) (log$ 0))
      (declare (type (f2cl-lib:integer4) log$ ier1))
      (setf ier 0)
      (cond
        ((< lensav
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::cfft2i
          ...
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :calls '(fortran-to-lisp::cfftmi fortran-to-lisp::xerfft))))
