...
(defun sinqmb (lot jump n inc x lenx wsave lensav work lenwrk ier)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((xhold 0.0d0) (kc 0) (ier1 0) (k 0) (ns2 0) (m 0) (lj 0))
      (declare (type (f2cl-lib:integer4) lj m ns2 k ier1 kc)
               (type (double-float) xhold))
      (setf ier 0)
      (cond
        ((< lenx
            (f2cl-lib:int-add
     ...
     label101
      ...
      (multiple-value-bind
            (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9
             var-10)
          (cosqmb lot jump n inc x lenx wsave lensav work lenwrk ier1)
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::sinqmb
          ...
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :return-values '(nil nil nil nil nil nil nil nil nil nil
                            fortran-to-lisp::ier)
           :calls '(fortran-to-lisp::cosqmb fortran-to-lisp::xercon
