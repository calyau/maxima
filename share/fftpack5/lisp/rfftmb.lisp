...
(defun rfftmb (lot jump n inc r lenr wsave lensav work lenwrk ier)
    ...
    (prog ()
      ...
      (cond
        ...
        ((not (xercon inc jump n lot))
         ...
         (xerfft "RFFTMB " -1)))
      (if (= n 1) (go end_label))
      (mrftb1 lot jump n inc r work wsave
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::rfftmb
          ...
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :return-values '(nil nil nil nil nil nil nil nil nil nil
                            fortran-to-lisp::ier)
           :calls '(fortran-to-lisp::mrftb1 fortran-to-lisp::xercon
