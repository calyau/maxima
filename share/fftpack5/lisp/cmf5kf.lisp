...
(let ((tr11 0.3090169943749474d0)
  ...
  (defun cmf5kf (lot ido l1 na cc im1 in1 ch im2 in2 wa)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((di2 0.0d0) (di5 0.0d0) (dr2 0.0d0) (dr5 0.0d0) (di4 0.0d0)
             (di3 0.0d0) (dr4 0.0d0) (dr3 0.0d0) (i 0) (m2 0) (ci4 0.0d0)
             (cr4 0.0d0) (ci5 0.0d0) (cr5 0.0d0) (ci3 0.0d0) (cr3 0.0d0)
             (ci2 0.0d0) (cr2 0.0d0) (chold2 0.0d0) (chold1 0.0d0) (tr3 0.0d0)
             (tr4 0.0d0) (tr2 0.0d0) (tr5 0.0d0) (ti3 0.0d0) (ti4 0.0d0)
             (ti2 0.0d0) (ti5 0.0d0) (m1 0) (k 0) (sn 0.0d0) (m2s 0) (m1d 0))
        (declare (type (f2cl-lib:integer4) m1d m2s k m1 m2 i)
                 (type (double-float) sn ti5 ti2 ti4 ti3 tr5 tr2 tr4 tr3 chold1
        ...
        (setf sn (/ 1.0d0 (f2cl-lib:freal (f2cl-lib:int-mul 5 l1))))
        (if (= na 1) (go label106))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::cmf5kf
