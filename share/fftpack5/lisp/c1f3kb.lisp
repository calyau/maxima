...
(let ((taur -0.5d0) (taui 0.866025403784439d0))
  ...
  (defun c1f3kb (ido l1 na cc in1 ch in2 wa)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((di3 0.0d0) (di2 0.0d0) (dr3 0.0d0) (dr2 0.0d0) (i 0) (ci3 0.0d0)
             (cr3 0.0d0) (ci2 0.0d0) (ti2 0.0d0) (cr2 0.0d0) (tr2 0.0d0) (k 0))
        (declare (type (f2cl-lib:integer4) k i)
                 (type (double-float) tr2 cr2 ti2 ci2 cr3 ci3 dr2 dr3 di2 di3))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::c1f3kb
