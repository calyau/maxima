...
(defun sint1f (n inc x lenx wsave lensav work lenwrk ier)
    ...
    (prog ((ier1 0))
      ...
      (cond
        ...
        ((< lensav
         ...
         (xerfft "SINT1F" 8)
         (go label100))
        ((< lenwrk (f2cl-lib:int-add (f2cl-lib:int-mul 2 n) 2))
         (setf ier 3)
         (xerfft "SINT1F" 10)
         (go label100)))
      (multiple-value-bind (var-0 var-1 var-2 var-3 var-4 var-5 var-6)
          (sintf1 n inc x wsave work
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::sint1f
          ...
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :return-values '(nil nil nil nil nil nil nil nil
                            fortran-to-lisp::ier)
           :calls '(fortran-to-lisp::sintf1 fortran-to-lisp::xerfft))))
