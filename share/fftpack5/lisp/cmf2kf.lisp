...
(defun cmf2kf (lot ido l1 na cc im1 in1 ch im2 in2 wa)
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::cmf2kf
