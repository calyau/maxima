...
(defun cfft1f (n inc c lenc wsave lensav work lenwrk ier)
  (declare (type (array double-float (*)) work wsave)
           (type (array f2cl-lib:complex16 (*)) c)
           (type (f2cl-lib:integer4) ier lenwrk lensav lenc inc n))
    ...
    (prog ((iw1 0))
      ...
      (cond
        ...
        ((< lensav
         ...
         (setf ier 2)
         (xerfft "CFFT1F " 6))
        ((< lenwrk (f2cl-lib:int-mul 2 n))
         (setf ier 3)
         (xerfft "CFFT1F " 8)))
      (if (= n 1) (go end_label))
      (setf iw1 (f2cl-lib:int-add n n 1))
      (c1fm1f n inc c work wsave
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::cfft1f
          ...
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :return-values '(nil nil nil nil nil nil nil nil
                            fortran-to-lisp::ier)
           :calls '(fortran-to-lisp::c1fm1f fortran-to-lisp::xerfft))))
