...
(defun mradb4 (m ido l1 cc im1 in1 ch im2 in2 wa1 wa2 wa3)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((ic 0) (i 0) (idp2 0) (m1 0) (m2 0) (k 0) (sqrt2 0.0d0) (m2s 0)
           (m1d 0))
      (declare (type (double-float) sqrt2)
      ...
      (setf sqrt2 (f2cl-lib:fsqrt 2.0d0))
          ...
          (f2cl-lib:fdo (m1 1 (f2cl-lib:int-add m1 im1))
            ...
            (tagbody
              ...
              (setf (f2cl-lib:fref ch-%data%
                                   (m2 1 k 3)
                                   ((1 in2) (1 ido) (1 l1) (1 4))
                                   ch-%offset%)
                      (-
                       (+
                        (f2cl-lib:fref cc-%data%
                                       (m1 1 1 k)
                                       ((1 in1) (1 ido) (1 4) (1 l1))
                                       cc-%offset%)
                        (f2cl-lib:fref cc-%data%
                                       (m1 ido 4 k)
                                       ((1 in1) (1 ido) (1 4) (1 l1))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::mradb4
