...
(defun cosqmf (lot jump n inc x lenx wsave lensav work lenwrk ier)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((ier1 0) (tsqx 0.0d0) (m 0) (ssqrt2 0.0d0) (lj 0))
     ...
     label103
      (multiple-value-bind (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7)
          (mcsqf1 lot jump n inc x wsave work ier1)
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::cosqmf
          ...
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :return-values '(nil nil nil nil nil nil nil nil nil nil
                            fortran-to-lisp::ier)
           :calls '(fortran-to-lisp::mcsqf1 fortran-to-lisp::xercon
