...
(defun cmfm1b (lot jump n inc c ch wa fnf fac)
        ...
        (tagbody
         ...
         label52
          (let ((%copy-c
            ...
            (cmf2kb lot ido l1 na %copy-c jump inc ch 1 lot
         ...
         label62
          (let ((%copy-c
                 (f2cl-lib:make-compatible-seq (array double-float (*))
                                               ...
                                               (array f2cl-lib:complex16 (*)))))
            (f2cl-lib:f2cl-copy-seq %copy-c c double-float f2cl-lib:complex16)
            (cmf2kb lot ido l1 na ch 1 lot %copy-c jump inc
             (f2cl-lib:array-slice wa-%data%
                                   double-float
                                   (iw)
                                   ((1 *))
         ...
         label53
          (let ((%copy-c
                 (f2cl-lib:make-compatible-seq (array double-float (*))
                                               ...
                                               (array f2cl-lib:complex16 (*)))))
            (f2cl-lib:f2cl-copy-seq %copy-c c double-float f2cl-lib:complex16)
            (cmf3kb lot ido l1 na %copy-c jump inc ch 1 lot
             (f2cl-lib:array-slice wa-%data%
                                   double-float
                                   (iw)
                                   ((1 *))
         ...
         label63
          (let ((%copy-c
                 (f2cl-lib:make-compatible-seq (array double-float (*))
                                               ...
                                               (array f2cl-lib:complex16 (*)))))
            (f2cl-lib:f2cl-copy-seq %copy-c c double-float f2cl-lib:complex16)
            (cmf3kb lot ido l1 na ch 1 lot %copy-c jump inc
             (f2cl-lib:array-slice wa-%data%
                                   double-float
                                   (iw)
                                   ((1 *))
         ...
         label54
          (let ((%copy-c
                 (f2cl-lib:make-compatible-seq (array double-float (*))
                                               ...
                                               (array f2cl-lib:complex16 (*)))))
            (f2cl-lib:f2cl-copy-seq %copy-c c double-float f2cl-lib:complex16)
            (cmf4kb lot ido l1 na %copy-c jump inc ch 1 lot
             (f2cl-lib:array-slice wa-%data%
                                   double-float
                                   (iw)
                                   ((1 *))
         ...
         label64
          (let ((%copy-c
                 (f2cl-lib:make-compatible-seq (array double-float (*))
                                               ...
                                               (array f2cl-lib:complex16 (*)))))
            (f2cl-lib:f2cl-copy-seq %copy-c c double-float f2cl-lib:complex16)
            (cmf4kb lot ido l1 na ch 1 lot %copy-c jump inc
             (f2cl-lib:array-slice wa-%data%
                                   double-float
                                   (iw)
                                   ((1 *))
         ...
         label55
          (let ((%copy-c
                 (f2cl-lib:make-compatible-seq (array double-float (*))
                                               ...
                                               (array f2cl-lib:complex16 (*)))))
            (f2cl-lib:f2cl-copy-seq %copy-c c double-float f2cl-lib:complex16)
            (cmf5kb lot ido l1 na %copy-c jump inc ch 1 lot
             (f2cl-lib:array-slice wa-%data%
                                   double-float
                                   (iw)
                                   ((1 *))
         ...
         label65
          (let ((%copy-c
                 (f2cl-lib:make-compatible-seq (array double-float (*))
                                               ...
                                               (array f2cl-lib:complex16 (*)))))
            (f2cl-lib:f2cl-copy-seq %copy-c c double-float f2cl-lib:complex16)
            (cmf5kb lot ido l1 na ch 1 lot %copy-c jump inc
             (f2cl-lib:array-slice wa-%data%
                                   double-float
                                   (iw)
                                   ((1 *))
         ...
         label56
          (let ((%copy-c
                 (f2cl-lib:make-compatible-seq (array double-float (*))
                                               ...
                                               (array f2cl-lib:complex16 (*)))))
            (f2cl-lib:f2cl-copy-seq %copy-c c double-float f2cl-lib:complex16)
            (cmfgkb lot ido ip l1 lid na %copy-c %copy-c jump inc ch ch 1 lot
             (f2cl-lib:array-slice wa-%data%
                                   double-float
                                   (iw)
                                   ((1 *))
         ...
         label66
          (let ((%copy-c
                 (f2cl-lib:make-compatible-seq (array double-float (*))
                                               ...
                                               (array f2cl-lib:complex16 (*)))))
            (f2cl-lib:f2cl-copy-seq %copy-c c double-float f2cl-lib:complex16)
            (cmfgkb lot ido ip l1 lid na ch ch 1 lot %copy-c %copy-c jump inc
             (f2cl-lib:array-slice wa-%data%
                                   double-float
                                   (iw)
                                   ((1 *))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::cmfm1b
          ...
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :return-values '(nil nil nil nil nil nil nil nil nil)
           :calls '(fortran-to-lisp::cmfgkb fortran-to-lisp::cmf5kb
                    fortran-to-lisp::cmf4kb fortran-to-lisp::cmf3kb
                    fortran-to-lisp::cmf2kb))))
