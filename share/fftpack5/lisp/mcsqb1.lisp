...
(defun mcsqb1 (lot jump n inc x wsave work ier)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((m1 0) (kc 0) (k 0) (ier1 0) (lnwk 0) (lnsv 0) (lenx 0) (modn 0)
           (xim1 0.0d0) (m 0) (i 0) (np2 0) (ns2 0) (lj 0))
      (declare (type (double-float) xim1)
               (type (f2cl-lib:integer4) lj ns2 np2 i m modn lenx lnsv lnwk
                                         ier1 k kc m1))
      (setf ier 0)
      (setf lj
              (f2cl-lib:int-add
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::mcsqb1
          ...
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :calls '(fortran-to-lisp::xerfft fortran-to-lisp::rfftmb))))
