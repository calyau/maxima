...
(defun cost1f (n inc x lenx wsave lensav work lenwrk ier)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((ier1 0))
      ...
      (multiple-value-bind (var-0 var-1 var-2 var-3 var-4 var-5)
          (costf1 n inc x wsave (aref work 0) ier1)
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::cost1f
          ...
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :return-values '(nil nil nil nil nil nil nil nil
                            fortran-to-lisp::ier)
           :calls '(fortran-to-lisp::costf1 fortran-to-lisp::xerfft))))
