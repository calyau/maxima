...
(defun c1fm1f (n inc c ch wa fnf fac)
        ...
        (tagbody
         ...
         label52
          (let ((%copy-c
            ...
            (c1f2kf ido l1 na %copy-c inc2 ch 2
         ...
         label62
          (let ((%copy-c
                 (f2cl-lib:make-compatible-seq (array double-float (*))
                                               ...
                                               (array f2cl-lib:complex16 (*)))))
            (f2cl-lib:f2cl-copy-seq %copy-c c double-float f2cl-lib:complex16)
            (c1f2kf ido l1 na ch 2 %copy-c inc2
             (f2cl-lib:array-slice wa-%data%
                                   double-float
                                   (iw)
                                   ((1 *))
         ...
         label53
          (let ((%copy-c
                 (f2cl-lib:make-compatible-seq (array double-float (*))
                                               ...
                                               (array f2cl-lib:complex16 (*)))))
            (f2cl-lib:f2cl-copy-seq %copy-c c double-float f2cl-lib:complex16)
            (c1f3kf ido l1 na %copy-c inc2 ch 2
             (f2cl-lib:array-slice wa-%data%
                                   double-float
                                   (iw)
                                   ((1 *))
         ...
         label63
          (let ((%copy-c
                 (f2cl-lib:make-compatible-seq (array double-float (*))
                                               ...
                                               (array f2cl-lib:complex16 (*)))))
            (f2cl-lib:f2cl-copy-seq %copy-c c double-float f2cl-lib:complex16)
            (c1f3kf ido l1 na ch 2 %copy-c inc2
             (f2cl-lib:array-slice wa-%data%
                                   double-float
                                   (iw)
                                   ((1 *))
         ...
         label54
          (let ((%copy-c
                 (f2cl-lib:make-compatible-seq (array double-float (*))
                                               ...
                                               (array f2cl-lib:complex16 (*)))))
            (f2cl-lib:f2cl-copy-seq %copy-c c double-float f2cl-lib:complex16)
            (c1f4kf ido l1 na %copy-c inc2 ch 2
             (f2cl-lib:array-slice wa-%data%
                                   double-float
                                   (iw)
                                   ((1 *))
         ...
         label64
          (let ((%copy-c
                 (f2cl-lib:make-compatible-seq (array double-float (*))
                                               ...
                                               (array f2cl-lib:complex16 (*)))))
            (f2cl-lib:f2cl-copy-seq %copy-c c double-float f2cl-lib:complex16)
            (c1f4kf ido l1 na ch 2 %copy-c inc2
             (f2cl-lib:array-slice wa-%data%
                                   double-float
                                   (iw)
                                   ((1 *))
         ...
         label55
          (let ((%copy-c
                 (f2cl-lib:make-compatible-seq (array double-float (*))
                                               ...
                                               (array f2cl-lib:complex16 (*)))))
            (f2cl-lib:f2cl-copy-seq %copy-c c double-float f2cl-lib:complex16)
            (c1f5kf ido l1 na %copy-c inc2 ch 2
             (f2cl-lib:array-slice wa-%data%
                                   double-float
                                   (iw)
                                   ((1 *))
         ...
         label65
          (let ((%copy-c
                 (f2cl-lib:make-compatible-seq (array double-float (*))
                                               ...
                                               (array f2cl-lib:complex16 (*)))))
            (f2cl-lib:f2cl-copy-seq %copy-c c double-float f2cl-lib:complex16)
            (c1f5kf ido l1 na ch 2 %copy-c inc2
             (f2cl-lib:array-slice wa-%data%
                                   double-float
                                   (iw)
                                   ((1 *))
         ...
         label56
          (let ((%copy-c
                 (f2cl-lib:make-compatible-seq (array double-float (*))
                                               ...
                                               (array f2cl-lib:complex16 (*)))))
            (f2cl-lib:f2cl-copy-seq %copy-c c double-float f2cl-lib:complex16)
            (c1fgkf ido ip l1 lid na %copy-c %copy-c inc2 ch ch 2
             (f2cl-lib:array-slice wa-%data%
                                   double-float
                                   (iw)
                                   ((1 *))
         ...
         label66
          (let ((%copy-c
                 (f2cl-lib:make-compatible-seq (array double-float (*))
                                               ...
                                               (array f2cl-lib:complex16 (*)))))
            (f2cl-lib:f2cl-copy-seq %copy-c c double-float f2cl-lib:complex16)
            (c1fgkf ido ip l1 lid na ch ch 2 %copy-c %copy-c inc2
             (f2cl-lib:array-slice wa-%data%
                                   double-float
                                   (iw)
                                   ((1 *))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::c1fm1f
          ...
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :return-values '(nil nil nil nil nil nil nil)
           :calls '(fortran-to-lisp::c1fgkf fortran-to-lisp::c1f5kf
                    fortran-to-lisp::c1f4kf fortran-to-lisp::c1f3kf
                    fortran-to-lisp::c1f2kf))))
