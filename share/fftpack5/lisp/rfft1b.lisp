...
(defun rfft1b (n inc r lenr wsave lensav work lenwrk ier)
  (declare (type (array double-float (*)) work wsave r)
           (type (f2cl-lib:integer4) ier lenwrk lensav lenr inc n))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::rfft1b
          ...
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :return-values '(nil nil nil nil nil nil nil nil
                            fortran-to-lisp::ier)
           :calls '(fortran-to-lisp::rfftb1 fortran-to-lisp::xerfft))))
