...
(defun cfftmb (lot jump n inc c lenc wsave lensav work lenwrk ier)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((iw1 0))
      ...
      (cmfm1b lot jump n inc c work wsave
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::cfftmb
          ...
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :return-values '(nil nil nil nil nil nil nil nil nil nil
                            fortran-to-lisp::ier)
           :calls '(fortran-to-lisp::cmfm1b fortran-to-lisp::xercon
