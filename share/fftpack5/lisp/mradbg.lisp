...
(defun mradbg (m ido ip l1 idl1 cc c1 c2 im1 in1 ch ch2 im2 in2 wa)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((idij 0) (is 0) (ar2h 0.0d0) (ai2 0.0d0) (ar2 0.0d0) (ds2 0.0d0)
           ...
           (ic 0) (j2 0) (jc 0) (j 0) (m1 0) (m2 0) (i 0) (k 0) (ipph 0)
           (ipp2 0) (nbd 0) (idp2 0) (dsp 0.0d0) (dcp 0.0d0) (arg 0.0d0)
           (tpi 0.0d0) (m2s 0) (m1d 0))
      (declare (type (double-float) tpi arg dcp dsp ar1 ai1 ar1h dc2 ds2 ar2
                                    ai2 ar2h)
               (type (f2cl-lib:integer4) m1d m2s idp2 nbd ipp2 ipph k i m2 m1 j
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::mradbg
