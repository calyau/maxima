...
(defun cosqb1 (n inc x wsave work ier)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((kc 0) (k 0) (ier1 0) (lnwk 0) (lnsv 0) (lenx 0) (modn 0)
           (xim1 0.0d0) (i 0) (np2 0) (ns2 0))
      (declare (type (double-float) xim1)
               (type (f2cl-lib:integer4) ns2 np2 i modn lenx lnsv lnwk ier1 k
                                         kc))
      (setf ier 0)
          ...
          (setf xim1
                  (+
                   (f2cl-lib:fref x-%data%
                                  ...
                                  ((1 inc) (1 *))
                                  x-%offset%)
                   (f2cl-lib:fref x-%data% (1 i) ((1 inc) (1 *)) x-%offset%)))
                  ...
                  (+
                   (*
                    (f2cl-lib:fref wsave-%data%
                                   ...
                                   ((1 *))
                                   wsave-%offset%)
                    (f2cl-lib:fref x-%data% (1 kc) ((1 inc) (1 *)) x-%offset%))
                   (*
                    (f2cl-lib:fref wsave-%data%
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::cosqb1
          ...
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :calls '(fortran-to-lisp::xerfft fortran-to-lisp::rfft1b))))
