      ...
      (f2cl-lib:with-multi-array-data
        ...
        (prog ()
         ...
         label500
          ...
          (dcopy np1 y 1 dz 1)
          (setf wk (coerce -1.0 'double-float))
  ...
  (setf (gethash 'fortran-to-lisp::fixpqs
          ...
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :calls '(fortran-to-lisp::dnrm2 fortran-to-lisp::daxpy
                    fortran-to-lisp::rootqs fortran-to-lisp::stepqs
                    fortran-to-lisp::dcopy fortran-to-lisp::d1mach))))
