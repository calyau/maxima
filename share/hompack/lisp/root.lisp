  ...
  (defun root (t$ ft b c relerr abserr iflag)
    ...
    (prog ()
     ...
     label400
      ...
      (if (/= (f2cl-lib:sign 1.0d0 fb) (f2cl-lib:sign 1.0d0 fc)) (go label1))
      (setf c a)
      (setf fc fa)
      (go label1)
     label8
      (if (= (f2cl-lib:sign 1.0d0 fb) (f2cl-lib:sign 1.0d0 fc)) (go label11))
