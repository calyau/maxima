...
(let* ((limitd 1000))
  ...
  (let ((y1sout 0.0d0)
    ...
    (defun fixpds
           (n y iflag arctol eps trace$ a ndima nfe arclen yp ypold qr lenqr
            pivot pp work wt phi p par ipar)
      (declare (type (array f2cl-lib:integer4 (*)) ipar)
               ...
               (type (array double-float (*)) p phi wt work pp qr ypold yp a y)
               (type (f2cl-lib:integer4) lenqr nfe ndima trace$ iflag n))
        ...
        (prog ()
         ...
         label10
          ...
          (setf (f2cl-lib:fref work-%data%
                               ((f2cl-lib:int-mul 2 np1))
                               ((1
                                 (f2cl-lib:int-add
                                  (f2cl-lib:int-mul 6 (f2cl-lib:int-add n 1))
                                  lenqr)))
                               work-%offset%)
                  (coerce 0.0 'double-float))
          (setf (f2cl-lib:fref work-%data%
                               ((f2cl-lib:int-mul 3 np1))
                               ((1
                                 (f2cl-lib:int-add
                                  (f2cl-lib:int-mul 6 (f2cl-lib:int-add n 1))
                                  lenqr)))
          ...
          (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
            ...
            (tagbody
              ...
              (setf (f2cl-lib:fref work-%data%
                      ...
                      (coerce 0.0 'double-float))
              (setf (f2cl-lib:fref work-%data%
                                   ((f2cl-lib:int-add (f2cl-lib:int-mul 2 np1)
                                                      j))
                                   ((1
                                     (f2cl-lib:int-add
                                      (f2cl-lib:int-mul 6
         ...
         label35
          (f2cl-lib:fdo (iter 1 (f2cl-lib:int-add iter 1))
            ...
            (tagbody
              (cond
                ((< (f2cl-lib:fref y (np1) ((1 (f2cl-lib:int-add n 1)))) 0.0)
                 (tagbody
                  label40
             ...
             label100
              ...
              (multiple-value-bind
                    (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8
                     ...
                     var-33 var-34)
                  (stepds #'fodeds np1 y s h epsstp wt start hold k kold crash
                   phi p yp alphas w g ksteps xold ivc iv kgi gi ypold a qr
                   lenqr pivot pp work nfec iflagc par ipar)
                (declare (ignore var-0 var-1 var-2 var-6 var-12 var-13 var-14
                                 var-15 var-16 var-17 var-21 var-23 var-24
                                 var-25 var-26 var-28 var-29 var-30 var-33
                                 var-34))
                (setf s var-3)
                (setf h var-4)
                (setf epsstp var-5)
             ...
             label130
              (cond
                ((>= (f2cl-lib:fref y (np1) ((1 (f2cl-lib:int-add n 1)))) 1.0)
                 (tagbody
                   (if st99 (go label160))
                   (setf s99 (- s (* 0.5 hold)))
                  label135
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::fixpds
          ...
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :return-values '(nil nil fortran-to-lisp::iflag
                            ...
                            fortran-to-lisp::arclen nil nil nil
                            fortran-to-lisp::lenqr nil nil nil nil nil nil nil
                            nil)
           :calls '(fortran-to-lisp::root fortran-to-lisp::sintrp
                    fortran-to-lisp::stepds fortran-to-lisp::f
                    fortran-to-lisp::rhoa fortran-to-lisp::dcopy))))
