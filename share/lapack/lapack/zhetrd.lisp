  ...
  (defun zhetrd (uplo n a lda d e tau work lwork info)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((i 0) (iinfo 0) (iws 0) (j 0) (kk 0) (ldwork 0) (lwkopt 0) (nb 0)
        ...
        (declare (type (f2cl-lib:integer4) i iinfo iws j kk ldwork lwkopt nb
                                           nbmin nx)
        ...
        (cond
          ((/= info 0)
           (xerbla "ZHETRD" (f2cl-lib:int-sub info))
           (go end_label))
          (lquery
           (go end_label)))
        (cond
           ...
           (cond
             ((< nx n)
              ...
              (cond
                ((< lwork iws)
                 (setf nb
                         (max (the f2cl-lib:integer4 (truncate lwork ldwork))
                              1))
                 (setf nbmin (ilaenv 2 "ZHETRD" uplo n -1 -1 -1))
                 (if (< nb nbmin) (setf nx n)))))
             (t
              (setf nx n))))
          (t
           (setf nb 1)))
          ...
          (upper
           ...
           (f2cl-lib:fdo (i (f2cl-lib:int-add n (f2cl-lib:int-sub nb) 1)
             ...
             (tagbody
               ...
               (zher2k uplo "No transpose" (f2cl-lib:int-sub i 1) nb (- cone)
             ...
             (tagbody
               (zlatrd uplo (f2cl-lib:int-add (f2cl-lib:int-sub n i) 1) nb
                ...
                (f2cl-lib:array-slice tau-%data%
                                      ...
                                      tau-%offset%)
                work ldwork)
               (zher2k uplo "No transpose"
                (f2cl-lib:int-add (f2cl-lib:int-sub n i nb) 1) nb (- cone)
                (f2cl-lib:array-slice a-%data%
                                      f2cl-lib:complex16
                                      ((+ i nb) i)
                                      ((1 lda) (1 *))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::zhetrd
          ...
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :calls '(fortran-to-lisp::zhetd2 fortran-to-lisp::zher2k
                    fortran-to-lisp::zlatrd fortran-to-lisp::xerbla
