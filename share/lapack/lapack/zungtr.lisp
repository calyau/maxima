  ...
  (defun zungtr (uplo n a lda tau work lwork info)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((i 0) (iinfo 0) (j 0) (lwkopt 0) (nb 0) (lquery nil) (upper nil))
        ...
        (cond
          ((/= info 0)
           (xerbla "ZUNGTR" (f2cl-lib:int-sub info))
           (go end_label))
          (lquery
           (go end_label)))
        (cond
        ...
        (go end_label)
       end_label
        (return (values nil nil nil lda nil nil nil info))))))
  ...
  (setf (gethash 'fortran-to-lisp::zungtr
          ...
          (fortran-to-lisp::make-f2cl-finfo
           :arg-types '((string) (fortran-to-lisp::integer4)
                        ...
                        (fortran-to-lisp::integer4)
                        (fortran-to-lisp::integer4))
           :return-values '(nil nil nil fortran-to-lisp::lda nil nil nil
                            fortran-to-lisp::info)
           :calls '(fortran-to-lisp::zungqr fortran-to-lisp::zungql
