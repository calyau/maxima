...
(let* ((one 1.0d0) (zero 0.0d0))
  (declare (type (double-float 1.0d0 1.0d0) one)
           ...
           (ignorable one zero))
  (defun zlasr (side pivot direct m n c s a lda)
    (declare (type (array f2cl-lib:complex16 (*)) a)
             (type (array double-float (*)) s c)
             (type (f2cl-lib:integer4) lda n m)
             (type (string *) direct pivot side))
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((temp #C(0.0d0 0.0d0)) (ctemp 0.0d0) (stemp 0.0d0) (i 0) (info 0)
             (j 0))
        (declare (type (f2cl-lib:complex16) temp)
                 (type (double-float) ctemp stemp)
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::zlasr fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo
           :arg-types '((string) (string) (string) (fortran-to-lisp::integer4)
