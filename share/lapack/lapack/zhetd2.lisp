  ...
  (defun zhetd2 (uplo n a lda d e tau info)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((alpha #C(0.0d0 0.0d0)) (taui #C(0.0d0 0.0d0)) (i 0) (upper nil))
        ...
        (cond
          ((/= info 0)
           (xerbla "ZHETD2" (f2cl-lib:int-sub info))
           (go end_label)))
        (if (<= n 0) (go end_label))
        (cond
          (upper
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::zhetd2
          ...
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :calls '(fortran-to-lisp::zher2 fortran-to-lisp::zaxpy
                    fortran-to-lisp::zdotc fortran-to-lisp::zhemv
                    fortran-to-lisp::zlarfg fortran-to-lisp::xerbla
