  ...
  (defun zsteqr (compz n d e z ldz work info)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((anorm 0.0d0) (b 0.0d0) (c 0.0d0) (eps 0.0d0) (eps2 0.0d0)
             ...
             (nmaxit 0))
        (declare (type (double-float) anorm b c eps eps2 f g p r rt1 rt2 s
                                      safmax safmin ssfmax ssfmin tst)
                 (type (f2cl-lib:integer4) i icompz ii iscale j jtot k l l1
                                           lend lendm1 lendp1 lendsv lm1 lsv m
                                           mm mm1 nm1 nmaxit))
        (setf info 0)
        (cond
          ((lsame compz "N")
        ...
        (cond
          ((/= info 0)
           (xerbla "ZSTEQR" (f2cl-lib:int-sub info))
           (go end_label)))
        (if (= n 0) (go end_label))
        (cond
          ((= n 1)
          ...
          ((> lend l)
           (tagbody
            label40
             (cond
               ((/= l lend)
                (setf lendm1 (f2cl-lib:int-sub lend 1))
            ...
            label60
             ...
             (cond
               ((= m (f2cl-lib:int-add l 1))
                (cond
                  ((> icompz 0)
                   (multiple-value-bind
                     ...
                     (setf c var-5)
                     (setf s var-6))
                   (setf (f2cl-lib:fref work-%data% (l) ((1 *)) work-%offset%)
                           c)
                ...
                (if (<= l lend) (go label40))
                (go label140)))
             (if (= jtot nmaxit) (go label140))
          ...
          (t
           (tagbody
            label90
             (cond
               ((/= l lend)
                (setf lendp1 (f2cl-lib:int-add lend 1))
                ...
                (cond
                  ((> icompz 0)
                   (multiple-value-bind
                     ...
                     (setf c var-5)
                     (setf s var-6))
                   (setf (f2cl-lib:fref work-%data% (m) ((1 *)) work-%offset%)
                           c)
                   (setf (f2cl-lib:fref work-%data%
                                        ((f2cl-lib:int-add
                                          (f2cl-lib:int-sub n 1)
                   ...
                   (multiple-value-bind (var-0 var-1 var-2 var-3 var-4)
                       (dlae2
                        ...
                        (f2cl-lib:fref e-%data%
                                       ...
                                       ((1 *))
                                       e-%offset%)
                        (f2cl-lib:fref d-%data% (l) ((1 *)) d-%offset%) rt1
                        rt2)
                     (declare (ignore var-0 var-1 var-2))
                     (setf rt1 var-3)
                     (setf rt2 var-4))))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::zsteqr
          ...
          (fortran-to-lisp::make-f2cl-finfo
           ...
           :calls '(fortran-to-lisp::zswap fortran-to-lisp::dlasrt
                    fortran-to-lisp::dlartg fortran-to-lisp::dlapy2
                    fortran-to-lisp::dlae2 fortran-to-lisp::zlasr
                    fortran-to-lisp::dlaev2 fortran-to-lisp::dlascl
                    fortran-to-lisp::dlanst fortran-to-lisp::zlaset
